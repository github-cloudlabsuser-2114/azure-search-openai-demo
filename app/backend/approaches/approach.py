...
Classes:
    ...
    Approach: An abstract base class for implementing different search and embedding approaches.
Functions:
    ...
    Approach.__init__: Initializes the Approach class with various clients and configuration parameters.
    ...
    Approach.run_stream: Abstract method to be implemented for running the approach in a streaming manner.
"""
from abc import ABC
